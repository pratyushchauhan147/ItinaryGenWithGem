...
const Header = () => {
  ...
  return (
    ...
    <div className=' h-[10vh] top-0  mb-[10vh] flex justify-between items-center'>
      ...
      <motion.h1 initial={{ scale: 0.5 ,rotate:5 }} animate={{ rotate: 0, scale: 1 }} transition={{type: "spring", stiffness: 260, damping: 20}} className=' text-[10vw] md:text-[4vw] leading-[1] p-3 font-bold'>WhereGo</motion.h1>
      <motion.div  whileHover={{scale:0.9,backgroundColor:'black'}  } className='nav links bg-[#0647B7] h-full flex items-center  '>
